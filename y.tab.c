...
{
       0,    66,    66,    70,    90,    96,    97,   101,   108,   115,
     121,   122,   125,   128,   130,   133,   134,   137,   138,   141,
     147,   164,   165,   168,   171,   172,   174,   190,   193,   194,
     197,   198,   199,   200,   201,   202,   203,   204,   207,   208,
     211,   214,   217,   220,   227,   229,   243,   245,   248,   249,
...
#line 175 "main.y" /* yacc.c:1646  */
    { 
			int varloc=est_deja_declare(getFunctionNum(),(yyvsp[0].s)); // vérifier qu'elle a été déclarer comme variable local
			int varglob=est_deja_declare(0,(yyvsp[0].s)); // cas global
			if (varloc!=-1)
				(yyval.np)=createIdentifierNode((yyvsp[0].s),getFunctionNum(),varloc) ; // type Identifiant
			else if (varglob!=-1)
